...
budgetValue = results[0];
dayBudgetValue = results[1];
levelValue = results[2];
expensesValue = results[3];
optionalExpensesValue = results[4];
incomesValue = results[5];
monthSavingsValue = results[6];
yearSavingsValue = results[7];
